...
def run_batch_ingestion(
    ...
    for result in results:
        ...
        filings = [filing for filing in result.get("filings", []) if isinstance(filing, dict)]
        if not filings:
            companies_minimal.append(
                {
                    "ticker": result.get("ticker"),
            ...
            companies_minimal.append(
                {
                    ...
                    "filing_type": filing.get("filing_type", result.get("filing_type")),
                    "period_of_report": filing.get("period_of_report", ""),
                    "filing_date": filing.get("filing_date", ""),
                    "filing_document_url": filing.get("filing_document_url", ""),
                    "local_document_path": filing.get("primary_document_path", ""),
                    "downloaded": filing.get("primary_document_saved", False),
                }
            )
        ...
        rows.append(
            {
                ...
                "filing_type": company.get("filing_type"),
