...
from backend.sanctions.matcher import (
...
class SanctionsMatcherTests(TestCase):
    ...
    def test_parse_aliases_strips_ofac_prefix_markers(self) -> None:
        self.assertEqual(
            ["AERO-CARIBBEAN", "AC AIR"],
            parse_aliases("A.K.A.: AERO-CARIBBEAN; F.K.A.: AC AIR"),
        )
